...
## Goal
Live web research, written to `docs/research/R2-services-regs.md`. Operating-area working assumption: Danish waters / Danish straits (flag it as an assumption in the doc). Questions:
...
## Files owned
Only: `docs/research/R2-services-regs.md`, `.orchestration/reports/U-R2.md`. Do NOT run git commit. No code.

## Report
`.orchestration/reports/U-R2.md`: summary, VERIFIED/ASSUMED split, dead ends, open uncertainties, contract version.
